...
class PdbxMasterViewDictionary(object):
    ...
    def __parseMaster(self, masterContainer):
        ...
        vD = {}
        if (vCat.hasAttribute("exptl") and vCat.hasAttribute("viewName") and
            vCat.hasAttribute("sections")):
    ...
    def __generateView(self, exptl, containerIn = None):
        ...
        __catMap = { 'pdbx_display_view_category_info' : ['view_id' , 
                                                          'category_menu_display_name',
                                                          'category_name',
                                                          'category_group_display_name',
                                                          'category_display_name',
                                                          'category_cardinality'],
                     'pdbx_display_view_item_info' : ['view_id',
                                                      'category_display_name',
                                                      'item_name', 
                                                      'item_display_name',
                                                      'read_only_flag']
