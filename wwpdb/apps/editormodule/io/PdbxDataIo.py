...
#                            Workaround put in to deal with "pdbx_database_related" being unique when purging skeleton categories in that its single non-primary key field may in fact be null.
...
#    2014-07-31    RPS    Implemented special handling for boundary validation of CIF category items that may be in comma separated values list form such as "diffrn_source.pdbx_wavelength_list"
#                            Will add to this list as other such items are encountered.
...
#    2016-03-02    RPS    __regexValidation() and setItemValue() updated to accommodate handling of unicode characters when allowed per EditorConfig.itemsAllowingUnicodeAccommodation list
...
class PdbxDataIo(object):
    ...
    def __init__(self,reqObj,verbose=False,log=sys.stderr):
        ...
        if (self.__verbose):
                self.__lfh.write("+%s.%s() defview %s\n" % (self.__class__.__name__,
                                                                                          sys._getframe().f_code.co_name, defView ) )
        ...
        #
        if (self.__verbose):
                self.__lfh.write("+%s.%s() path to view config file is: %s\n" % (self.__class__.__name__,
                                                                                          sys._getframe().f_code.co_name, self.__pathViewFile ) )
                self.__lfh.write("+%s.%s() path to view __pathPdbxDictFile is: %s\n" % (self.__class__.__name__,
                                                                                          sys._getframe().f_code.co_name, self.__pathPdbxDictFile ) )
        #
        ...
        self.__settingsNeedingColIdxTrnsfrm = ['COLUMN_BOUNDARY_VALUES','COLUMN_BOUNDARY_VALUES_ALT','COLUMN_REGEX','COLUMN_REGEX_ALT','COLUMN_ENUMS','COLUMN_ENUMS_ALT','COLUMN_DEFAULT_VALUES',
                                       'MANDATORY_COLUMNS','MANDATORY_COLUMNS_ALT','COLUMN_DESCRIPTIONS','COLUMN_DESCRIPTIONS_ALT','COLUMN_DISPLAY_ORDER','COLUMN_DISPLAY_NAMES','PRIMARY_KEYS','COLUMN_TYPES',
                                       'COLUMN_TYPES_ALT','COLUMN_EXAMPLES','COLUMN_EXAMPLES_ALT']
        #####################################################################################################################################
        #
                ...
                if os.access( self.__sessionSnapShotsPath, os.R_OK ):
                    if (self.__verbose):
                        self.__lfh.write("+%s.%s() dataFileSnapShot area read accessible at: %s\n" % (self.__class__.__name__,
                                                                                                      sys._getframe().f_code.co_name, self.__sessionSnapShotsPath ) )
        
        except:
            if (self.__verbose):
                self.__lfh.write("+%s.%s() problem creating snapshots area at: %s\n" % (self.__class__.__name__,
                                                                                          sys._getframe().f_code.co_name, self.__sessionSnapShotsPath ) )
            traceback.print_exc(file=self.__lfh)
            self.__lfh.flush()
    ...
    def __setPdbxDataFilePath(self):
        ...
        if( bIsWorkflow ):
            ...
            if self.__verbose:
                ...
                #
                if( bIsWorkflow ):
                    self.__lfh.write("+++%s.%s() SITE_ID is: %s.\n" % (self.__class__.__name__,
                                                                   sys._getframe().f_code.co_name,
                                                                   self.__cI.get("SITE_PREFIX") ) ) 
                    self.__lfh.write("+++%s.%s() deposition data set id is: %s.\n" % (self.__class__.__name__,
                                                                   sys._getframe().f_code.co_name,
                                                                   depDataSetId) )
            #
            ...
            #
            if self.__verbose:
                self.__lfh.write("+++%s.%s()  - model file path  %s\n" % (self.__class__.__name__,
                                                               sys._getframe().f_code.co_name, wfmPdbxFilePath) )
            ...
            #else:   self.__pathPdbxDataFile = "/wwpdb/source/python/pdbx/data/1kip.cif"
            
        self.__lfh.write("+++%s.%s()  - pdbx data file path is: %s\n" % (self.__class__.__name__,
        ...
        if self.__pathPdbxDataFile is not None and os.access(self.__pathPdbxDataFile,os.R_OK):
            ...
            if( bIsWorkflow ):
                ...
                if os.access(lclPdbxFilePath,os.R_OK):
                    ...
                    self.__lfh.write("+++%s.%s()  - could not find/access pdbx data file path at: %s\n" % (self.__class__.__name__,
                                                                   sys._getframe().f_code.co_name, lclPdbxFilePath) )
                    return None
                ...
                if dataFile:
                    sessionFilePath = os.path.join(self.__sessionPath,dataFile)
                    #
                    if os.access(sessionFilePath,os.R_OK):
                        self.__pathPdbxDataFile = sessionFilePath
                        return self.__pathPdbxDataFile
                    else:
                        self.__lfh.write("+++%s.%s()  - could not find/access pdbx data file path at: %s\n" % (self.__class__.__name__,
                                                                       sys._getframe().f_code.co_name, sessionFilePath) )
                        return None
                
            self.__lfh.write("+++%s.%s()  - Leaving and pdbx data file path is: %s\n" % (self.__class__.__name__,
                                                                   sys._getframe().f_code.co_name, self.__pathPdbxDataFile) )
    ...
    def initializeDataStore(self):
        ...
        try:
            ...
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- shelved cif data to %s\n" % (self.__class__.__name__,
                                                       sys._getframe().f_code.co_name,
                                                       self.__dbFilePath) )
    ...
    def getEntryAccessionIds(self,p_pdbxPersist):
        ...
        try:
            ...
            if( ctgryObj ):
                ...
                assert( iTotalRecords == 1 ), ("+%s.%s() -- expecting 'pdbx_depui_entry_details' category to contain a single record but had %s records\n" % (self.__class__.__name__,
                                                                                                                                              sys._getframe().f_code.co_name,
                                                                                                                                              iTotalRecords) )
                ctgryColList = (self.getCategoryColList( "pdbx_depui_entry_details" ))[1]
                if (self.__verbose and self.__debug ):
                    self.__lfh.write("+%s.%s() -- ctgryColList obtained as: %r\n" % (className, methodName, ctgryColList) )
                #
                for idx,name in enumerate(ctgryColList):
                    
                    if( name == "requested_accession_types" ):
                        if (self.__verbose and self.__debug ):
                            self.__lfh.write("+%s.%s() -- found 'requested_accession_types' field at index: %s with value: %s\n" % (className, methodName, idx, (fullRsltSet[0])[idx]) )
                        accessionIdsLst = ( fullRsltSet[0][idx] ).split(",")
                        break
                
                self.__lfh.write("+%s.%s() accessionIdsLst obtained as: %r\n" % (self.__class__.__name__, sys._getframe().f_code.co_name, accessionIdsLst ) )
    ...
    def getEntryTitle(self,p_pdbxPersist):
        ...
        try:
            ...
            if( ctgryObj ):
                ...
                assert( iTotalRecords == 1 ), ("+%s.%s() -- expecting 'struct' category to contain a single record but had %s records\n" % (self.__class__.__name__,
                                                                                                                                              sys._getframe().f_code.co_name,
                                                                                                                                              iTotalRecords) )
                ...
                for idx,name in enumerate(ctgryColList):
                    ...
                    if( name == "title" ):
                        if (self.__verbose and self.__debug ):
                            self.__lfh.write("+%s.%s() -- found 'title' field at index: %s with value: %s\n" % (className, methodName, idx, (fullRsltSet[0])[idx]) )
                        entryTitle = fullRsltSet[0][idx]
                        break
                
                self.__lfh.write("+%s.%s() entryTitle obtained as: '%s'\n" % (self.__class__.__name__, sys._getframe().f_code.co_name, entryTitle ) )
            else:
                if (self.__verbose):
                    self.__lfh.write("+%s.%s() -- 'struct' category not present in the model data file.\n" % (className, methodName) )
        except:
            traceback.print_exc(file=self.__lfh)
    ...
    def __getEntryExptlList(self,p_pdbxPersist):
        ...
        try:
            ...
            if( ctgryObj ):
                ...
                self.__lfh.write("+%s.%s() exptlLst obtained as: %r\n" % (self.__class__.__name__, sys._getframe().f_code.co_name, exptlLst ) )
        except:
            traceback.print_exc(file=self.__lfh)
    ...
    def makeDataStoreSnapShot(self,p_editActnIndx):
        ...
        if( int(p_editActnIndx) == 0 ):
            if(self.__verbose and self.__debug):
                self.__lfh.write("+%s.%s() -- p_editActnIndx is:  %s\n" % (self.__class__.__name__, sys._getframe().f_code.co_name, p_editActnIndx ) )
            
            if( os.access(snapShotFilePath,os.R_OK) ):
                if (self.__verbose):
                    self.__lfh.write("+%s.%s() --skipping over creation of zero-index dataFileSnapShot b/c already exists at:  %s\n" % (self.__class__.__name__,
                                                                                                      sys._getframe().f_code.co_name, snapShotFilePath ) )
                    self.__lfh.flush()
                return
            else:
                if (self.__verbose):
                    self.__lfh.write("+%s.%s() -- zero-index dataFileSnapShot does not yet exist at:  %s\n" % (self.__class__.__name__,
                                                                                                          sys._getframe().f_code.co_name, snapShotFilePath ) )
                    self.__lfh.flush()
        #        
        try:
            if self.__dbFilePath is not None and os.access(self.__dbFilePath,os.R_OK):
                if self.__sessionSnapShotsPath is not None and os.access(self.__sessionSnapShotsPath,os.R_OK):
                    ...
                    if os.access(snapShotFilePath,os.R_OK):
                        if (self.__verbose):
                            self.__lfh.write("+%s.%s() dataFileSnapShot successfully created at: %s\n" % (self.__class__.__name__,
                                                                                                      sys._getframe().f_code.co_name, snapShotFilePath ) )
                            self.__lfh.flush()
                    else:
                        if (self.__verbose):
                            self.__lfh.write("+%s.%s() problem creating dataFileSnapShot at: %s\n" % (self.__class__.__name__,
                                                                                                      sys._getframe().f_code.co_name, snapShotFilePath ) )
                            self.__lfh.flush()
        #
        except:
        ...
        if self.__sessionSnapShotsPath is not None and os.access(self.__sessionSnapShotsPath,os.R_OK):
            if( p_rewindIndex ):
                ...
                try:
                    ...
                    if (self.__verbose):
                        self.__lfh.write("+%s.%s() problem removing dataFileSnapShot at: %s\n" % (self.__class__.__name__,
                                                                                                  sys._getframe().f_code.co_name, snpShotFilePath ) )
                    traceback.print_exc(file=self.__lfh)
                    self.__lfh.flush()
            else:
            ...
            if (self.__verbose):
                self.__lfh.write("+%s.%s() dataFileSnapShots directory not accessible at: %s\n" % (self.__class__.__name__,
                                                                                                  sys._getframe().f_code.co_name, self.__sessionSnapShotsPath ) )
    ...
    def getDataStorePath(self):
        ...
        try:
            if self.__dbFilePath is not None and os.access(self.__dbFilePath,os.R_OK):
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- persistent dataStore DB file accessible at %s\n" % (self.__class__.__name__,
                                                       sys._getframe().f_code.co_name,
                                                       self.__dbFilePath) )
                ...
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- persistent dataStore DB file not found/accessible at %s\n" % (self.__class__.__name__,
                                                       sys._getframe().f_code.co_name,
                                                       self.__dbFilePath) )
                return None
        ...
        try:
            ...
            if self.__pathViewFile == None:
                ...
                if not viewContainer:
                    self.__lfh.write("+%s.%s() method not found in config: %s \n" % (self.__class__.__name__,
                                                                                     sys._getframe().f_code.co_name, methods ) )
                    methods = 'X-RAY'
                    viewContainer = dV.generateMethodsView(methods)
            ...
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- shelved dictionary of cif metadata to %s\n" % (self.__class__.__name__,
                                                       sys._getframe().f_code.co_name,
                                                       self.__dictDbFilePath) )
        ...
        try:
            if os.access(self.__dbFilePath,os.R_OK) and os.access(exprtDirPath,os.R_OK):
                ...
                if( success is not None and success is False ):
                    if( self.__verbose ):
                        self.__lfh.write("+%s.%s() -- WARNING: problem exporting updated cif file to %s\n" % (self.__class__.__name__,
                                                           sys._getframe().f_code.co_name,
                                                           exprtFilePath) )
                    return False
                    ...
                    # ZF, end DB loading
                    if( self.__verbose ):
                        self.__lfh.write("+%s.%s() -- exported updated cif file to %s\n" % (self.__class__.__name__,
                                                           sys._getframe().f_code.co_name,
                                                           exprtFilePath) )
                    return True
                #
            ...
            if (self.__verbose):
                    self.__lfh.write("+%s.%s() -- export of updated cif file to %s FAILED.\n" % (self.__class__.__name__,
                                               sys._getframe().f_code.co_name,
                                               exprtFilePath) )
            traceback.print_exc(file=self.__lfh)
    ...
    def getCtgryNavConfig(self):
        ...
        self.__lfh.write("+%s.%s() -- topLevelMenuList obtained as %r\n" % (self.__class__.__name__,
                                                   sys._getframe().f_code.co_name,
                                                   topLevelMenuList ) )
        # e.g. +PdbxDataIo.getCtgryNavConfig() -- topLevelMenuList obtained as ['Deposition', 'Related DB/Entry', 'Citation', 'Caveat', 'Entity Description', 'Polymer Source', 'Data Collection', 'Reflection/Refinement Data']
        ...
        for indx,topLevelMenuChoice in enumerate(topLevelMenuList):
            ...
            if( menuType == "dropdown" ):
                ...
                for idx,dropDwnLbl in enumerate(descriptors):
                    ...
                    if( idx > 0 and ( dropDwnLbl == descriptors[idx-1] ) ): continue
                    ...
                    for ctgryDisplLbl in ctgryDisplLbls:
                        ...
                        ctgryCrdnlty=dictViewInfo.getCategoryCardinality(viewId=currViewId,menuName=topLevelMenuChoice,categoryGroupName=dropDwnLbl,categoryDisplayName=ctgryDisplLbl)
            ...
            #
                ...
                for memberLbl in descriptors:
                    ...
                    for idx,ctgryDisplLbl in enumerate(ctgryDisplLbls):
                        ...
                        ctgryCrdnlty=dictViewInfo.getCategoryCardinality(viewId=currViewId,menuName=topLevelMenuChoice,categoryGroupName=memberLbl,categoryDisplayName=ctgryDisplLbl)
        ...
        #
        if( self.__debug ):
            self.__lfh.write("+%s.%s() -- navigation menu configList obtained as %r\n" % (self.__class__.__name__,
                                                   sys._getframe().f_code.co_name,
                                                   configList ) )
            ''' e.g. +PdbxDataIo.getCtgryNavConfig() -- navigation menu configList obtained as
             [
                {'no_dropdown_dict': {'Title+Entry%20status+Entry%20Authors+Contact%20Authors+Processing%20notes': ('struct+pdbx_database_status+audit_author+pdbx_contact_author+pdbx_database_proc', 'unit+unit+multi+multi+multi')},
                 'id': 0,
                 'dsply_lbl': 'Deposition',
                 'dsply_typ': 'no_dropdown'},
                
                {'no_dropdown_dict': {'Related%20Entries+TargetTrack+SG%20Project+Methods%20Development': ('pdbx_database_related+entity_poly+pdbx_SG_project+pdbx_database_status', 'multi+multi+multi+multi')},
                 'id': 1,
                ...
                {'no_dropdown_dict': {'Overall%20Data+Highest%20Resolution%20Shell+Overall%20Refinement%20Data+Highest%20Resolution%20Refinement%20Shell': ('reflns+reflns_shell+refine+refine_ls_shell', 'unit+multi+multi+multi')},
                 'id': 7,
            ...
            try:
                ...
                for line in ifh:
                    ...
                    if ctgryName not in skltnCtgryLst:
                        if( self.__verbose ):
                            self.__lfh.write("+%s.%s() -- Adding category '%s' to skltnCtgryLst, %r\n" % (self.__class__.__name__,
                                                                                                                                  sys._getframe().f_code.co_name,
                                                                                                                                  ctgryName,
                                                                                                                                  skltnCtgryLst) )
            ...
            if( curCtgryNm not in categoryHndldList and curCtgryNm not in skltnCtgryList ):
                ...
                if( ( ctgryRqstd != 'all' and ctgryRqstd == curCtgryNm ) or ( ctgryRqstd == 'all' ) ):
                    ...
                    if( ctgryObj ):
                        ...
                        mandatoryColLst = catObjDict['MANDATORY_COLUMNS_ALT'] if( catObjDict['MANDATORY_COLUMNS_ALT'] and len(catObjDict['MANDATORY_COLUMNS_ALT']) > 0 ) else \
                            catObjDict['MANDATORY_COLUMNS'] if( catObjDict['MANDATORY_COLUMNS'] and len(catObjDict['MANDATORY_COLUMNS']) > 0 ) else []
            
                        if( self.__debug ):
                            self.__lfh.write("+%s.%s() -- mandatoryColLst for %s obtained as %r\n" % (self.__class__.__name__,
                                                                   sys._getframe().f_code.co_name,
                                                                   curCtgryNm,
                                                                   mandatoryColLst ) )
                        #
                            ...
                            for rowIdx,record in enumerate(fullRsltSet):
                                try:
                                    if( record[colIdx] and (len(record[colIdx]) < 1 or record[colIdx] == '?') ):
                                        ...
                                        if( self.__debug ):
                                            self.__lfh.write("+%s.%s() ---- DEBUG ---- Missing non-null value for mandatory item %s in category %s\n" % (self.__class__.__name__,
                                                                                   sys._getframe().f_code.co_name,
                                                                                   colDisplName,
                                                                                   curCtgryNm ) )
                                        #
                                        ...
                                        if( self.__debug ):
                                            self.__lfh.write("+%s.%s() ---- DEBUG ---- Current rowIdx is '%s', colIdx is '%s', and missingMndtryItemsDict is now '%r'\n" % (self.__class__.__name__,
                                                                                       sys._getframe().f_code.co_name,
                                                                                       rowIdx, colIdx,
                                    ...
                                    self.__lfh.write("+%s.%s() ---- DEBUG ---- EXCEPTION: Current rowIdx is '%s', colIdx is '%s', and length of record is '%s' for category '%s'\n" % (self.__class__.__name__,
                                                                                   sys._getframe().f_code.co_name,
                                                                                   rowIdx,
                                                                                   colIdx, len(record),
                                                                                   curCtgryNm ) )
                                    self.__lfh.write("+%s.%s() ---- DEBUG ---- EXCEPTION: record is '%r'\n" % (self.__class__.__name__,
                                                                                   sys._getframe().f_code.co_name,
                                                                                   record ) )
                                    traceback.print_exc(file=self.__lfh)                        
                        #
                        ...
                        if( self.__debug ):
                            self.__lfh.write("+%s.%s() ---- DEBUG ---- category '%s' not found in deposited data.\n" % (self.__class__.__name__,
                                                                   sys._getframe().f_code.co_name,
                                                                   curCtgryNm ) )
        #
    ...
    def __getCategoryListForCurrentContext(self):
        ...
        for topLevelMenuChoice in topLevelMenuList:
            ...
            for idx,memberLbl in enumerate(descriptors):
                ...
                if( idx > 0 and ( memberLbl == descriptors[idx-1] ) ): continue
        ...
        #
        if( self.__debug ):
            self.__lfh.write("+%s.%s() -- categoryList obtained as %r\n" % (self.__class__.__name__,
                                                   sys._getframe().f_code.co_name,
                                                   categoryList ) )
        return categoryList
    ...
    def getTblConfigDict(self,p_categoryNm,p_catDispLabel):
        ...
        logger.info("---------------------------------")
        logger.info("Starting for %s %s at %s" % (p_categoryNm,p_catDispLabel, 
                                                  time.strftime("%Y %m %d %H:%M:%S", time.localtime())))
        #
        currViewId = self.__getConfigViewId()
        #
        ...
        if( bOk ):
            ...
            #ctgryMetaDict = self.__pdbxDictStore.fetchOneObject(dbFileName=self.__dictDbFilePath,objectName=p_categoryNm)
            ...
            if( ctgryMetaDict ):
                ...
                if( len(itemList) > 0 ):
                    ...
                    #
                    if( self.__verbose and self.__debug ):
                        self.__lfh.write("+%s.%s() -- itemList obtained as %r\n" % (self.__class__.__name__,
                                                               sys._getframe().f_code.co_name,
                                                               itemList ) )
                    #
                    colDisplNameDict={}
                    ...
                    if( self.__verbose and self.__debug ):
                        self.__lfh.write("+%s.%s() -- ctgryMetaDict['COLUMN_DISPLAY_ORDER'] now is %r\n" % (self.__class__.__name__,
                                                               sys._getframe().f_code.co_name,
                                                               ctgryMetaDict['COLUMN_DISPLAY_ORDER'] ) )
                ...
                if( self.__debug ):
                        self.__lfh.write("+%s.%s() -- new truCtgryColList now: %r\n" % (self.__class__.__name__,
                                                               sys._getframe().f_code.co_name,
                                                               truCtgryColList ) )
                        self.__lfh.write("+%s.%s() -- success flag returned by __generateMissingCtgryItems is: %s\n" % (self.__class__.__name__,
                                                               sys._getframe().f_code.co_name,
                                                               ok ) )
                ...
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- WARNING: no metaDict was available for '%s' so generating a dummy DataTable config stub for use by front end.\n" % (self.__class__.__name__,
                                                           sys._getframe().f_code.co_name,
                                                           p_categoryNm ) )
    ...
    def getCategoryColList(self, p_categoryNm):
        ...
        try:
            ...
            if( categoryObj ):
                ...
                if( self.__verbose ):
                    logger.debug("-- Category '%s' was not found in datafile so generating skeleton category.\n" % p_categoryNm)
                #
    ...
    def getCategoryRowList( self, p_ctgryNm, p_iDisplayStart, p_iDisplayLength, p_sSrchFltr, p_colSearchDict ):
        ...
        try:
            ...
            #
            '''
            for indx,record in enumerate( categoryObj.getRowList() ): 
                #self.__lfh.write("\nrow[%s] in %s is: %s\n" %(indx,p_ctgryNm,record))
                rtrnList.append(record)
            '''
            ...
            for i in range(iSortingCols):
                ...
                if sortFlag == 'true':
                    ...
                    if( self.__verbose ):
                        self.__lfh.write("+%s.%s() -- colIndx for %s is %s as derived from trueColList is %r\n" % (self.__class__.__name__,
                                                                                          sys._getframe().f_code.co_name,
                                                                                          colName, colIndx,
                                                                                          trueColList) )
                                ...
                                try:
                                    if( itemValue and ( len(itemValue) > 0 and self.__isNotCifNull( itemValue ) ) ):
                                        ...
                                        if( not self.__pdbxDictStore ):
                                            self.__pdbxDictStore=PdbxDictionaryInfoStore(verbose=self.__verbose,log=self.__lfh)
                                        #
                                        #ctgryMetaDict = self.__pdbxDictStore.fetchOneObject(dbFileName=self.__dictDbFilePath,objectName=curCtgryNm)
                                        ctgryMetaDict = self.__getCifCtgryMetaDict(curCtgryNm)
                                        if( ctgryMetaDict is None ):
                                            if( self.__debug ):
                                                self.__lfh.write("+%s.%s() -- WARNING: failed to obtain ctgryMetaDict for '%s'\n" % (self.__class__.__name__,
                                                                                           sys._getframe().f_code.co_name,
                                                                                           curCtgryNm ) )
                                        else:
                                            if( self.__debug ):
                                        ...
                                        if( vldtnTstRslts['pass_regex_tst'] == 'false' or vldtnTstRslts['pass_bndry_tst'] == 'false' ):
                                            ...
                                            if( self.__debug ):
                                                self.__lfh.write("+%s.%s() ---- DEBUG ---- Current rowIdx is '%s', colIdx is '%s', and violationsDict is now '%r'\n" % (self.__class__.__name__,
                                                                                       sys._getframe().f_code.co_name,
                                                                                       rowIdx, colIdx,
                                                                                       violationsDict ) )
                                #
                                    ...
                                    '''DELETE CANDIDATE
                                    if( ctgryRqstd == 'all' ):
                                        if( curCtgryNm not in violationsDict['violation_map'] ):
                                            violationsDict['violation_map'][curCtgryNm] = {}
                                    '''
    ...
    def validateItemValue(self, p_ctgryNm, p_newValue, p_rowIdx, p_colIdx ):
        ...
        try:
            myPersist=PdbxPersist(self.__verbose,self.__lfh)
            if( self.__debug ):
                self.__lfh.write("++++++++++++%s %s just before call to myPersist.fetchOneObject at %s\n" % (self.__class__.__name__,
                                                   sys._getframe().f_code.co_name,
                                                   time.strftime("%Y %m %d %H:%M:%S", time.localtime())))       
            #
            ...
            #
            if( self.__debug ):
                self.__lfh.write("++++++++++++%s %s just after call to myPersist.fetchOneObject at %s\n" % (self.__class__.__name__,
                                       sys._getframe().f_code.co_name,
                                       time.strftime("%Y %m %d %H:%M:%S", time.localtime())))       
            #
            if( ctgryObj.getRowCount() == 1 and self.__bUseTransposedTables ):
                bTrnspsdCtgry=True   #ASSUMPTION-that all categories for which only 1 record exists will be transposed such that row becomes column for display
                p_colIdx = p_rowIdx
                p_rowIdx = 0
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- Category being updated '%s' is being treated as TRANSPOSED.\n" % (self.__class__.__name__,
                                                                                                                 sys._getframe().f_code.co_name,
                                                                                                                 p_ctgryNm) )
            # 
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- Category name sought is '%s' and colIdx has value of: %s\n" % (self.__class__.__name__,
                                                                                  sys._getframe().f_code.co_name,
                                                                                  p_ctgryNm,
                                                                                  p_colIdx) )
            #
            ...
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- User has submitted update for category.item '%s.%s' with proposed value: '%r'\n" % (self.__class__.__name__,
                                                                                                                      sys._getframe().f_code.co_name,
                                                                                                                      p_ctgryNm,
                                                                                                                      attributeNm,
                                                                                                                      p_newValue) )
    ...
    def setItemValue(self, p_ctgryNm, p_newValue, p_rowIdx, p_colIdx ):
        ...
        try:
            ...
            # 
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- Category name sought is '%s' and p_colIdx has value of: %s\n" % (self.__class__.__name__,
                                                                                  sys._getframe().f_code.co_name,
                                                                                  p_ctgryNm,
                                                                                  p_colIdx) )
            #
            ...
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- Attribute list retrieved is: %s \n" % (self.__class__.__name__,
                                                                                     ...
                                                                                     str(attributeList) ) )
            #
            attributeNm = attributeList[p_colIdx]  # get name of category field based using column index returned from client and mapped against attribute list held by the categoryObject
            ...
            #
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- About to update category '%s' with updated value for '%s' as '%s' for row index [%s]\n" % (self.__class__.__name__,
                                                                                                                      sys._getframe().f_code.co_name,
                                                                                                                      p_ctgryNm,
                                                                                                                      attributeNm,
                                                                                                                      p_newValue,p_rowIdx) )
            #
            self.__lfh.write("+%s.%s() -- dbFilePath is: [%s] and dataBlockName is: '%s'\n" % (self.__class__.__name__,
                                                                                                                      sys._getframe().f_code.co_name,
                                                                                                                      self.__dbFilePath,
                                                                                                                      self.__dataBlockName) )
            #
            ...
            #
            if( self.__debug ):
                self.__lfh.write("++++++++++++%s %s just before call to myPersist.updateOneObject at %s\n" % (self.__class__.__name__,
                                       sys._getframe().f_code.co_name,
                                       time.strftime("%Y %m %d %H:%M:%S", time.localtime())))       
            #            
            bSuccess = myPersist.updateOneObject(ctgryObj, self.__dbFilePath, self.__dataBlockName)
            if( self.__debug ):
                self.__lfh.write("++++++++++++%s %s just after call to myPersist.updateOneObject at %s\n" % (self.__class__.__name__,
                                   sys._getframe().f_code.co_name,
                                   time.strftime("%Y %m %d %H:%M:%S", time.localtime())))       
            #             
        except:
        ...
        try:
            ...
            if( ctgryObj is None ):
                ...
                for dicattributeNm in dicAttributeList:
                    if( self.__debug ):
                        self.__lfh.write("++++++++++++%s %s building skeleton cifCategory container with attribute: %s\n" % (self.__class__.__name__,
                                                                                                                             sys._getframe().f_code.co_name,
                                                                                                                             dicattributeNm))
                    #
            ...
            #
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- About to update category '%s' with new row as %r\n" % (self.__class__.__name__,
                                                                                                                      sys._getframe().f_code.co_name,
                                                                                                                      cifCtgryNm,
                                                                                                                      rowToAdd) )
            #
    ...
    def rmSkipCalcRequest(self, p_task):
        ...
        try:
            ...
            if colIdx is not None:
                for idx,record in enumerate(rowList):
                    try:
                        ...
                        if (self.__verbose and self.__debug ):
                            self.__lfh.write("+%s.%s() -- ValueError found when comparing '%s' with '%s' so comparison not used to determine need for readjusting values of ordinal id field.\n" % (self.__class__.__name__, sys._getframe().f_code.co_name, record[colIdx], taskName ) )
                        continue
            ...
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- About to update category '%s' by deleting row #%s, %r\n" % (self.__class__.__name__,
                                                                                                                      sys._getframe().f_code.co_name,
                                                                                                                      cifCtgryNm,
                                                                                                                      rowIdx,
                                                                                                                      rowBeingDeleted) )
    ...
    def checkSkipCalcRequest(self, p_task):
        ...
        try:
            ...
            if( ctgryObj ):
                ...
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- '%s' did contain request to skip calculation for %s\n" % (self.__class__.__name__,
                                                                                                                          sys._getframe().f_code.co_name,
                                                                                                                          cifCtgryNm,
                                                                                                                          p_task) )
                #
    ...
    def addNewRow(self, p_ctgryNm):
        ...
        try:
            ...
            #
            if( self.__debug ):
                self.__lfh.write("++++++++++++%s %s just after existence check/creation of PdbxDictionary at %s\n" % (self.__class__.__name__,
                                       sys._getframe().f_code.co_name,
                                       time.strftime("%Y %m %d %H:%M:%S", time.localtime())))
            ...
            if( self.__debug ):
                self.__lfh.write("+%s.%s() -- ctgryMetaDict['COLUMN_DEFAULT_VALUES'] obtained as %r\n" % (self.__class__.__name__,
                                                       sys._getframe().f_code.co_name,
                                                       ctgryMetaDict['COLUMN_DEFAULT_VALUES'] ) )
                self.__lfh.write("+%s.%s() -- ctgryMetaDict['PRIMARY_KEYS'] obtained as %r\n" % (self.__class__.__name__,
                                                       sys._getframe().f_code.co_name,
                                                       ctgryMetaDict['PRIMARY_KEYS'] ) )
            #
    ...
    def __genRowOfDefaultValues(self,p_ctgryNm,p_ctgryMetaDict,p_attributeList,p_context,p_ctgryObj=None,p_ordinalId=None,p_cloneDict=None):
        ...
        if( p_context == "__createSkeletonCtgryContainer" ):
            excludeList.extend(["entity_src_nat.entity_id", "entity_src_gen.entity_id", "pdbx_entity_src_syn.entity_id","pdbx_entity_src_syn.pdbx_src_id","database_PDB_caveat.id"])
            excludeList.extend(["pdbx_refine_tls_group.id","struct_ncs_ens.id","struct_ncs_dom.id","struct_ncs_dom.pdbx_ens_id","struct_ncs_dom_lim.dom_id","struct_ncs_dom_lim.pdbx_component_id","struct_ncs_dom_lim.pdbx_ens_id","struct_mon_prot_cis.pdbx_id"])
        #
        for index,attributeNm in enumerate(p_attributeList):
            ...
            if( p_ctgryNm+"."+attributeNm == "pdbx_database_related.content_type" and p_context in ["addNewRow","insertRow","__createSkeletonCtgryContainer"]):
                ...
                if( p_ctgryNm+"."+attributeNm not in excludeList ):
                    ...
                    self.__lfh.write("+%s.%s() -- value of ID to be assigned as autoincrement  for '%s.%s' is: %s.\n" % (self.__class__.__name__,
                                                       sys._getframe().f_code.co_name,
                                                       p_ctgryNm, attributeNm, defaultVal ) )
                #
                else:
                    self.__lfh.write("+%s.%s() -- '%s.%s' is in exclusion list when called in context of '%s', so not autoincremented.\n" % (self.__class__.__name__,
                                                       sys._getframe().f_code.co_name,
                                                       p_ctgryNm, attributeNm, p_context ) )
                #
                if( "entry_id" in attributeNm ): # examples ['pdbx_database_proc.entry_id','atom_sites.entry_id']
                    ...
                    self.__lfh.write("+%s.%s() -- value of ID to be auto-assigned for '%s.%s' is: %s.\n" % (self.__class__.__name__,
                                                           sys._getframe().f_code.co_name,
                                                           p_ctgryNm, attributeNm, defaultVal ) )
            elif ( p_ctgryNm+"."+attributeNm in ["pdbx_entity_src_syn.pdbx_alt_source_flag","pdbx_database_related.content_type"] ) and ( p_context=="__createSkeletonCtgryContainer" ) :
                defaultVal = "?"
    ...
    def deleteRows(self, p_ctgryNm, p_rowIdx, p_iNumRows=None):
        ...
        try:
                ...
                if colIdx is not None:
                    ...
                    for idx,record in enumerate(rowList):
                        try:
                            ...
                            if (self.__verbose and self.__debug ):
                                self.__lfh.write("+%s.%s() -- ValueError found when comparing '%s' with '%s' so comparison not used to determine need for readjusting values of ordinal id field.\n" % (self.__class__.__name__, sys._getframe().f_code.co_name, record[colIdx], deletedOrdinalValue ) )
                            continue
            ...
            if( self.__verbose ):
                ...
                self.__lfh.write("+%s.%s() -- %s in category '%s'\n" % (self.__class__.__name__,
                                                                      sys._getframe().f_code.co_name,
                                                                      sErrMsg,
                                                                      p_ctgryNm) )
    ...
    def insertRows(self, p_ctgryNm, p_rowIdx, p_relativePos="after", p_cloneList=None, p_iNumRows=None):
        ...
        try:
            ...
            #
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- Current row is: %r \n" % (self.__class__.__name__,
                                                                        sys._getframe().f_code.co_name,
                                                                        rowList[p_rowIdx]) )
            ...
            for n in range( p_iNumRows ):
                ...
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- About to update category '%s' by inserting row, %r,\n%s row#%s\n" % (self.__class__.__name__,
                                                                                                                          sys._getframe().f_code.co_name,
                                                                                                                          p_ctgryNm,
                                                                                                                          newRow,
                                                                                                                          p_relativePos,
        ...
        for idx,record in enumerate(p_recordset):
            try:
                ...
                if ordinalId == int(p_newValue):
                    ...
                    self.__lfh.write("+%s.%s() -- autoIncrementNeeded set to True.\n" % (self.__class__.__name__, sys._getframe().f_code.co_name ) )
                    break
            
            except ValueError:
                if (self.__verbose and self.__debug ):
                    self.__lfh.write("+%s.%s() -- therefore '%s' is not used to determine need for readjusting values of ordinal id field.\n" % (self.__class__.__name__, sys._getframe().f_code.co_name, record[p_colIdx] ) )
                continue
        
        try:            
            if( autoIncrementNeeded ):
                self.__lfh.write("+%s.%s() -- autoIncrementNeeded needed so updating recordset.\n" % (self.__class__.__name__, sys._getframe().f_code.co_name ) )
                for idx,record in enumerate(p_recordset):
                    ordinalId = int(record[p_colIdx])
                    if ordinalId >= int(p_newValue):
            ...
            traceback.print_exc(file=self.__lfh)
            self.__lfh.write("+%s.%s() -- failed for '%s'.\n" % (self.__class__.__name__, sys._getframe().f_code.co_name, p_attributeNm ) )
    ...
    def undoEdits(self, p_cifCtgry, p_rewindIndex):
        ...
        #
        if (self.__verbose):
            self.__lfh.write("+%s.%s() p_rewindIndex is: %s\n" % (self.__class__.__name__, sys._getframe().f_code.co_name, p_rewindIndex ) )
        ...
        try:
            if os.access(rewindToSnapShotFilePath,os.F_OK):
                ...
                #
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- Reverting to prior state just for category: '%s'\n" % (self.__class__.__name__,
                                                                                      sys._getframe().f_code.co_name,
                                                                                      p_cifCtgry) )
                #
                ...
                if (self.__verbose):
                    self.__lfh.write("+%s.%s() problem accessing dataFileSnapShot file at: %s\n" % (self.__class__.__name__,
                                                                                              sys._getframe().f_code.co_name, rewindToSnapShotFilePath ) )
        #
        except:
            if (self.__verbose):
                self.__lfh.write("+%s.%s() problem reverting db file at [%s] to prior state just for category '%s'.\n" % (self.__class__.__name__,
                                                                                                  sys._getframe().f_code.co_name, self.__dbFilePath, p_cifCtgry ) )
            traceback.print_exc(file=self.__lfh)
            self.__lfh.flush()                
        #
    ...
    def __getCifCtgryMetaDict(self,p_sCtgryName,p_bCreateStub=False):
        ...
        if( (rtrnDict is None) and p_bCreateStub ):
            ...
            if( p_sCtgryName == "pdbx_display_view_category_info" ):
                rtrnDict['COLUMN_NAMES'] = ['view_id', 'category_menu_display_name', 'category_name', 'category_group_display_name', 'category_display_name', 'category_cardinality']
    ...
    def __getNextOrdinalValue(self,p_ctgryObj,p_attributeNm):
        ...
        try:
            ...
            if (self.__verbose and self.__debug ):
                self.__lfh.write("+%s.%s() -- ctgryNm obtained as: %s\n" % (className, methodName, ctgryNm) )
                self.__lfh.write("+%s.%s() -- fullRsltSet obtained as: %r\n" % (className, methodName, fullRsltSet) )
            ...
            for idx,name in enumerate(ctgryColList):
                ...
                if( name == p_attributeNm ):
                    if (self.__verbose and self.__debug ):
                        self.__lfh.write("+%s.%s() -- '%s' field corresponds to index: [%s]\n" % (className, methodName, p_attributeNm, idx) )
            ...
            for i,record in enumerate(fullRsltSet):
                if (self.__verbose and self.__debug ):
                    self.__lfh.write("+%s.%s() -- for row #%s, record[%s] is '%s'\n" % (className, methodName, i, desiredIdx, record[desiredIdx] ) )
                try:
                    if int(record[desiredIdx]) > int(currentMax):
                        currentMax = int(record[desiredIdx])
                except ValueError:
                    if (self.__verbose and self.__debug ):
                        self.__lfh.write("+%s.%s() -- therefore '%s' is not used to determine current max value of ordinal id field.\n" % (className, methodName, record[desiredIdx] ) )
                
            self.__lfh.write("+%s.%s() currentMax obtained as: '%s'\n" % (self.__class__.__name__, sys._getframe().f_code.co_name, currentMax ) )
    ...
    def __orderBy(self, sortlist, orderby=[], desc=[]):
        ...
        if( self.__verbose and self.__debug ):
            for entry in sortlist:
                dtype = type(entry)
                self.__lfh.write("+%s.%s() -- DEBUG -- entry in sortlist is of type '%s' and its content is: %r \n" % (self.__class__.__name__,
                                                                                      sys._getframe().f_code.co_name,
                                                                                      dtype,
                                                                                      entry) )
        ...
        for colIndx in orderby:
            ...
            for dictEntry in sortlist:
                try:
                    ...
                    if( self.__verbose and self.__debug ):
                        self.__lfh.write("+%s.%s() -- DEBUG -- instance of colIndx '%s' found to be non integer value.\n" % (self.__class__.__name__,
                                                                                              sys._getframe().f_code.co_name,
                                                                                              colIndx) )
                    break
...
#            currViewId = "NMR1"
        ...
        if( self.__verbose ):
            self.__lfh.write("+%s.%s() returning currViewId as: %s \n" % (self.__class__.__name__,
                                                                                              sys._getframe().f_code.co_name, currViewId ) )
        return currViewId
            ...
            try:
                ...
                for line in ifh:
                    ...
                    if ctgryName not in purgeCategoryList:
                        if( self.__verbose ):
                            self.__lfh.write("+%s.%s() -- Adding category '%s' to purgeCategoryList, %r\n" % (self.__class__.__name__,
                                                                                                                                  sys._getframe().f_code.co_name,
                                                                                                                                  ctgryName,
                                                                                                                                  purgeCategoryList) )
            ...
            if ctgryObj:
                ...
                for rowIdx,record in enumerate(rowList):
                    ...
                    for colIdx,value in enumerate(record):
                        ...
                        #
                        if( cifCtgryNm+"."+attributeNm in EditorConfig.autoIncrDecrList  ) or (  ("id" in attributeNm) and (attributeNm in primaryKeyListFrmDict) and ( cifCtgryNm+"."+attributeNm not in excludeList ) ):
                        ...
                        if( value != '?' and value != "." and not bSpecialTreatmentAttribute  ):
                            #self.__lfh.write("+%s.%s() -- Row: %s, Col: %s ---> Default Value for this column is: %s \n" % (self.__class__.__name__,
                            #                                                             sys._getframe().f_code.co_name, rowIdx, colIdx, defaultVal) )
                            #self.__lfh.write("+%s.%s() -- Row: %s ---> Value: '%s' obtained in column [%s] from ctgryObj for '%s' corresponds to: %s \n" % (self.__class__.__name__,
                            #                                                             sys._getframe().f_code.co_name, rowIdx, value, colIdx, cifCtgryNm, attributeNm) )
                            if( defaultVal == "none" ):
                                    bRemoveRow = False
                    ...
                    if bRemoveRow:
                        if( self.__debug ):
                            self.__lfh.write("+%s.%s() -- bRemoveRow is '%s' so adding rowIdx [%s] to rowsBeingDeleted, %r for cifCtgryNm, '%s'\n" % (self.__class__.__name__,
                                                                                                                                  sys._getframe().f_code.co_name,
                                                                                                                                  bRemoveRow,
                                                                                                                                  rowIdx,
                                                                                                                                  rowsBeingDeleted,
                ...
                if len(rowsBeingDeleted) > 0:
                    for rowIndx in reversed(rowsBeingDeleted):
                        ...
                        if( self.__verbose ):
                            self.__lfh.write("+%s.%s() -- Going to update category '%s' by deleting row #%s, %r\n" % (self.__class__.__name__,
                                                                                                                                  sys._getframe().f_code.co_name,
                                                                                                                                  cifCtgryNm,
                                                                                                                                  rowIndx,
                                                                                                                                  rowBeingDeleted) )
                            self.__lfh.write("+%s.%s() -- Attribute list retrieved from ctgryObj is: %s \n" % (self.__class__.__name__,
                                                                                                 sys._getframe().f_code.co_name,
                                                                                                 str(attributeList) ) )
                            self.__lfh.write("+%s.%s() -- Primary key list retrieved from metaDict is: %s \n" % (self.__class__.__name__,
                                                                                                 sys._getframe().f_code.co_name,
                                                                                                 str(primaryKeyListFrmDict) ) )
                            
                            self.__lfh.write("+%s.%s() -- Default Values retrieved from metaDict is: %r \n" % (self.__class__.__name__,
                                                                                                 sys._getframe().f_code.co_name,
                                                                                                 defaultValuesFrmDict ) )
                    #
                    ctgryObj.setRowList(rowList)
                    ...
                    if( self.__verbose ):
                        self.__lfh.write("+%s.%s() -- NO rows being deleted for category '%s' \n" % (self.__class__.__name__,
                                                                                                          sys._getframe().f_code.co_name,
                                                                                                          cifCtgryNm) )
            ...
            if( indxOrdinal >= 0 ):
                ...
                if( self.__debug ):
                    self.__lfh.write("++++++++++++%s.%s() just after call to myPersist.updateOneObject at %s\n" % (self.__class__.__name__,
                                       sys._getframe().f_code.co_name,
                                       time.strftime("%Y %m %d %H:%M:%S", time.localtime())))
                    self.__lfh.write("++++++++++++%s.%s() just after call to myPersist.updateOneObject and bSuccess is %s\n" % (self.__class__.__name__,
                                       sys._getframe().f_code.co_name, bSuccess) )
                #
            else:
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- unable to identify '%s.%s' in data.\n" % (self.__class__.__name__,
                                                                                                      sys._getframe().f_code.co_name, p_ctgryName, targetAttributeNm ) )
        else:
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- '%s' category not found in data.\n" % (self.__class__.__name__,
                                                                                                  sys._getframe().f_code.co_name, p_ctgryName) )
        ...
        if os.access(self.__dbFilePath,os.R_OK):
            ...
            if srcCtgryObj:
                ...
                if( indxSrcTitle >= 0 ):
                    ...
                    if( self.__verbose ):
                        self.__lfh.write("+%s.%s() -- title '%s' from source category '%s' obtained from row# %s \n" % (self.__class__.__name__,
                                                                                                              sys._getframe().f_code.co_name,
                                                                                                              srcTitleValue,
                                                                                                              srcCtgry,
                                                                                                              rowNum) )
                    ...
                    if( idxTargetTitle >= 0 ):
                        ...
                        if( self.__verbose ):
                            self.__lfh.write("+%s.%s() -- title '%s' from target category '%s' obtained from row# %s \n" % (self.__class__.__name__,
                                                                                                                  sys._getframe().f_code.co_name,
                                                                                                                  targetTitleValue,
                                                                                                                  p_targetCtgry,
                                                                                                                  targetRowNmbr) )
                    ...
                    if( self.__verbose ):
                        self.__lfh.write("+%s.%s() -- unable to identify '%s.%s' in data.\n" % (self.__class__.__name__,
                                                                                                          sys._getframe().f_code.co_name, srcCtgry, targetAttributeNm ) )
            else:
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- '%s' category not found in data.\n" % (self.__class__.__name__,
                                                                                                      sys._getframe().f_code.co_name, srcCtgry) )
    ...
    def __generateMissingCtgryItems(self,p_categoryNm,p_ctgryColList,p_attribsForDisplay):
        ...
        #
        if( self.__verbose ):
            self.__lfh.write("+%s.%s() -- p_attribsForDisplay is: %r\n" % (self.__class__.__name__,
                                                                                  sys._getframe().f_code.co_name,
                                                                                  p_attribsForDisplay) )
        for attribName in p_attribsForDisplay:
                if attribName not in p_ctgryColList:
                    if( self.__verbose ):
                        self.__lfh.write("+%s.%s() -- identified missing attrib '%s' for category '%s'\n" % (self.__class__.__name__,
                                                                                  sys._getframe().f_code.co_name,
                                                                                  attribName, p_categoryNm) )
        ...
        if( bUpdateRequired == True ):
            ...
            #
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- Need to supply placeholder(s) for missing cif items for category: '%s'\n" % (self.__class__.__name__,
                                                                                  sys._getframe().f_code.co_name,
                                                                                  p_categoryNm) )
            #
            categoryObj = myPersist.fetchOneObject(self.__dbFilePath, self.__dataBlockName, p_categoryNm)
            ...
            #
            if( self.__debug ):
                self.__lfh.write("++%s %s fullRsltSet is now %r\n" % (self.__class__.__name__,
                                   sys._getframe().f_code.co_name,
                                   fullRsltSet))
            #
            bSuccess = myPersist.updateOneObject(categoryObj, self.__dbFilePath, self.__dataBlockName)
    ...
    def __convertNamesToColIndxs(self,p_ctgryColList,p_data):
        ...
        '''
        if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- colNameToIdxDict generated as %r\n" % (self.__class__.__name__,
                                                       sys._getframe().f_code.co_name,
    ...
    def __regexValidation(self,p_ctgryMetaDict,p_ctgryNm,p_attributeNm,p_newValue):
        ...
        if( regEx ):
            regEx += '$'
            if( self.__debug ):
                self.__lfh.write("+%s.%s() -- COLUMN_REGEX(_ALT) obtained for '%s.%s' as %r\n" % (self.__class__.__name__,
                                                                                           sys._getframe().f_code.co_name,
                                                                                           p_ctgryNm,
                                                                                           p_attributeNm,
                                                                                           regEx ) )
            ...
            if( matchObj ):
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- new value of '%r' passes validation against COLUMN_REGEX for '%s.%s' as %r\n" % (self.__class__.__name__,
                                                                                               sys._getframe().f_code.co_name,
                                                                                               p_newValue,
                                                                                               p_ctgryNm,
                                                                                               p_attributeNm,
                ...
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- new value of '%r' failed validation against COLUMN_REGEX for '%s.%s' as %r\n" % (self.__class__.__name__,
                                                                                               sys._getframe().f_code.co_name,
                                                                                               p_newValue,
                                                                                               p_ctgryNm,
                                                                                               p_attributeNm,
            ...
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- no COLUMN_REGEX(_ALT) defined for '%s.%s'\n" % (self.__class__.__name__,
                                                                                           sys._getframe().f_code.co_name,
                                                                                           p_ctgryNm,
                                                                                           p_attributeNm ) )
            #
    ...
    def __boundaryValidation(self,p_ctgryMetaDict,p_ctgryNm,p_attributeNm,p_newValue):
        ...
        try:
            ...
            if( bndryDictSoft is None and bndryDictHard is None ):
                if( self.__verbose ):
                    self.__lfh.write("+%s.%s() -- no COLUMN_BOUNDARY_VALUES(_ALT) defined for '%s.%s'\n" % (self.__class__.__name__,
                                                                                               sys._getframe().f_code.co_name,
                                                                                               p_ctgryNm,
                                                                                               p_attributeNm ) )
                ...
                if( bndryDictHard ):
                    if( self.__verbose ):
                        self.__lfh.write("+%s.%s() -- Checking against 'hard' COLUMN_BOUNDARY_VALUES for '%s.%s'\n" % (self.__class__.__name__,
                                                                                               sys._getframe().f_code.co_name,
                                                                                               p_ctgryNm,
                                                                                               p_attributeNm ) )
                    #
                    ...
                    if( rsltTupl[0] == False ):
                        ...
                        if( bndryDictSoft ):
                            if( self.__verbose ):
                                self.__lfh.write("+%s.%s() -- Checking against 'soft' COLUMN_BOUNDARY_VALUES_ALT for '%s.%s'\n" % (self.__class__.__name__,
                                                                                                       sys._getframe().f_code.co_name,
                                                                                                       p_ctgryNm,
                                                                                                       p_attributeNm ) )
                    ...
                    if( self.__verbose ):
                        self.__lfh.write("+%s.%s() -- No 'hard' boundary limits for '%s.%s'\n" % (self.__class__.__name__,
                                                                                               sys._getframe().f_code.co_name,
                                                                                               p_ctgryNm,
                                                                                               p_attributeNm ) )
                    if( bndryDictSoft ):
                        if( self.__verbose ):
                            self.__lfh.write("+%s.%s() -- Proceeding to check against 'soft' COLUMN_BOUNDARY_VALUES_ALT for '%s.%s'\n" % (self.__class__.__name__,
                                                                                               sys._getframe().f_code.co_name,
                                                                                               p_ctgryNm,
                                                                                               p_attributeNm ) )
                        rsltTupl = self.__checkAgainstBoundaries( p_ctgryNm, bndryDictSoft, p_attributeNm, p_newValue, "soft" )
            ...
            if( self.__verbose ):
                traceback.print_exc(file=self.__lfh)
                self.__lfh.write("+%s.%s() -- Problem during validation of new value of '%s' for '%s.%s' \n" % (self.__class__.__name__,
                                                                                           sys._getframe().f_code.co_name,
                                                                                           p_newValue,
                                                                                           p_ctgryNm,
                                                                                           p_attributeNm ) )
    ...
    def __checkAgainstBoundaries( self, p_ctgryNm, p_bndryDict, p_attributeNm, p_newValue, p_limitType ):
            ...
            try:
                for (lB,uB) in bList:
                    ...
                    if ( ((len(lB) > 1) and '.' in lB) or  ((len(uB) > 1) and '.' in uB) ):
                        if( self.__verbose  and self.__debug ):
                            self.__lfh.write("(checkBoundaryValues) testing constraint as float %s %s\n" % (lB,uB))
                        rtrnTupl = self.__testFloatBoundary(p_newValue,lB,uB,p_limitType)
                        if( rtrnTupl[0] == True ):
                            if( self.__verbose ):
                                self.__lfh.write("+%s.%s() -- new value of '%s' passes validation against float COLUMN_BOUNDARY_VALUES(_ALT) for '%s.%s' as %r\n" % (self.__class__.__name__,
                                                                                                           sys._getframe().f_code.co_name,
                                                                                                           p_newValue,
                                                                                                           p_ctgryNm,
                                                                                                           p_attributeNm,
                                                                                                           bList ) )
                            return rtrnTupl
                        elif( rtrnTupl[0] == False ):
                            if( failSummaryMsg != rtrnTupl[1] and len(rtrnTupl[1]) > 1 ):  # to prevent duplicate messages
                                failSummaryMsg += (separator+rtrnTupl[1])
                            if( self.__verbose ):
                                self.__lfh.write("+%s.%s() -- new value of '%s' failed validation against float COLUMN_BOUNDARY_VALUES(_ALT) of %r for '%s.%s' for reason: %s\n" % (self.__class__.__name__,
                                                                                                   sys._getframe().f_code.co_name,
                                                                                                   p_newValue,
                                                                                                   bList,
                                                                                                   p_ctgryNm,
                        ...
                        if( self.__verbose and self.__debug ):
                            self.__lfh.write("(checkBoundaryValues) testing constraint as integer %s %s\n" % (lB,uB))
                        rtrnTupl = self.__testIntBoundary(p_newValue,lB,uB,p_limitType)
                        if( rtrnTupl[0] == True ):
                            if( self.__verbose ):
                                self.__lfh.write("+%s.%s() -- new value of '%s' passes validation against integer COLUMN_BOUNDARY_VALUES(_ALT) for '%s.%s' as %r\n" % (self.__class__.__name__,
                                                                                                           sys._getframe().f_code.co_name,
                                                                                                           p_newValue,
                                                                                                           p_ctgryNm,
                                                                                                           p_attributeNm,
                            ...
                            if failSummaryMsg != rtrnTupl[1]:
                                failSummaryMsg += (separator+rtrnTupl[1])
                            if( self.__verbose ):
                                self.__lfh.write("+%s.%s() -- new value of '%s' failed validation against integer COLUMN_BOUNDARY_VALUES(_ALT) of %r for '%s.%s' for reason: %s\n" % (self.__class__.__name__,
                                                                                                   sys._getframe().f_code.co_name,
                                                                                                   p_newValue,
                                                                                                   bList,
                                                                                                   p_ctgryNm,
                ...
                if( self.__verbose ):
                    traceback.print_exc(file=self.__lfh)
                    self.__lfh.write("+%s.%s() -- new value of '%s' failed validation against COLUMN_BOUNDARY_VALUES(_ALT) for '%s.%s' as %r\n" % (self.__class__.__name__,
                                                                                               sys._getframe().f_code.co_name,
                                                                                               p_newValue,
                                                                                               p_ctgryNm,
                                                                                               p_attributeNm,
        ...
        if( rtrnTupl[0] == False ):
            ...
            if( self.__verbose ):
                self.__lfh.write("+%s.%s() -- new value of '%s' failed validation against COLUMN_BOUNDARY_VALUES(_ALT) of %r for '%s.%s' for reason: %s\n" % (self.__class__.__name__,
                                                                                           sys._getframe().f_code.co_name,
                                                                                           p_newValue,
                                                                                           bList,
                                                                                           p_ctgryNm,
