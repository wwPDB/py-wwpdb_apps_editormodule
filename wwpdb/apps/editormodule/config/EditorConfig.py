...
class EditorConfig(object):
    ...
    autoIncrDecrList = [ "audit_author.pdbx_ordinal",
    ...
    autoIncrExclList = [ "atom_sites.entry_id",
                         "chem_comp.id", 
                         "citation.id",
    ...
    sortColDict = {"audit_author":"pdbx_ordinal", 
                   "citation_author":"ordinal", 
                   "em_author_list":"ordinal",
                   "entity":"id", 
                   "entity_poly":"entity_id", 
    ...
    itemsAllowingUnicodeAccommodation = ["audit_author.name",
    ...
    arrReadOnlyCtgries = ['pdbx_chem_comp_depositor_info',
    ...
    itemsAllowingOverrideRegex= ["audit_author.name",
                                 "citation_author.name"]
